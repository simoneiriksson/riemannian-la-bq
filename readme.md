...
The project presents a method for uncertainty estimation in machine learning models, exploiting the curvature of the loss function and Bayesian Quadrature, to make efficient parameter samples from the posterior distribution.
