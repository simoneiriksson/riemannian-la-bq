...
The Exp-map corresponds to solving the initial value problem for the differential equation \hl{REFERENCE Frølich paper}:
\begin{equation}
...
\begin{figure}[ht]
    ...
    \subfloat[Riemannian Laplace approximation for UFA]{
        \includegraphics[width=.31\linewidth]{report/figures/UFA_riemannian_subspace_rank1.png}
