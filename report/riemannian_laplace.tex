...
The Exp-map corresponds to solving an initial value problem the differential equation:
\begin{equation}
...
\begin{figure}[h]
    ...
    \subfloat[Riemannian Laplace approximation for UFA]{
        \includegraphics[width=.45\linewidth]{report/figures/UFA_riemannian_subspace_rank1.png}
        \label{fig:UFA_riemannian_subspace_rank1}
    }
    \hfill
    \subfloat[Riemannian Laplace samples from banana distribution]{
        \includegraphics[width=.45\linewidth]{report/figures/banana_distr_contour_riemannshots.png}
        \label{fig:banana_distr_contour_riemannshots}
    }
    \hfill
    \subfloat[Laplace approximation to the banana distribution]{
        \includegraphics[width=.45\linewidth]{report/figures/banana_distr_contour_laplace.png}
...
In figure \ref{fig:banana_distr_contour_riemannshots} 50 evaluations of the Exp-map 

In figure \ref{fig:UFA_riemannian_subspace_rank1}, we see the resulting UFA with prediction bands, as given by the Riemmanian Laplace approximation, sampled only along the first eigendirection. 
